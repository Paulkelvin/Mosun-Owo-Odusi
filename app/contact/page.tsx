    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="section-padding bg-gradient-to-br from-white via-primary-50/20 to-gold-50/10">
        <div className="container-custom">
          {/* Contact Cards Grid */}
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-32 max-w-none mx-auto px-2 lg:px-8">
            ...
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-large p-6 lg:p-10 relative overflow-hidden self-start"
            >
            ...
            <div className="space-y-8">
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-primary-700 to-primary-600 rounded-3xl p-6 lg:p-10 text-white"
              >
              ...
              <motion.div
                ...
                className="bg-white rounded-3xl shadow-large p-6 lg:p-8"
              >
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-gold-50 to-amber-50 rounded-3xl p-6 lg:p-8 border border-gold-200/50"
              >
