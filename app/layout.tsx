...
export const metadata: Metadata = {
  ...
  description: 'Project leader with 30+ years experience driving education reform, including OGSTEP, a World Bank-funded initiative impacting 72,000+ beneficiaries.',
  ...
  twitter: {
    ...
    title: 'Mosun Owo-Odusi | Project Manager & Education Consultant',
    description: 'Project leader with 30+ years experience driving education reform. OGSTEP: World Bank-funded, 72,000+ beneficiaries.',
