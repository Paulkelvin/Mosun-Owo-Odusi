...
export default function About({ data }: { data?: any } = {}) {
  ...
  const careerMilestones = data?.careerPositions?.length
    ? data.careerPositions.map((c: any, i: number) => ({
        id: i,
        period: c.period,
        duration: '',
        title: c.title,
    ...
    <div className="min-h-screen">
      ...
      <section id="about-hero" className="relative overflow-hidden mt-16 lg:mt-20">
        <div className="absolute inset-0">
          <Image
            src={data?.heroImageUrl ?? '/images/mosun_owo-odusi_portrait.png'}
            ...
            <div className="relative">
              <div className="relative max-w-sm mx-auto rounded-3xl overflow-hidden shadow-[0_22px_70px_rgba(15,23,42,0.85)] border border-slate-800 bg-slate-900">
                <div className="relative aspect-[3/4]">
                  <Image
                    src={data?.portraitUrl ?? '/images/Mosun Owo-Odusi.jpg'}
          ...
          <div className="max-w-none mx-auto"> {/* Removed max-width constraint */}
            <div className="relative">
              ...
              <div className="space-y-8 md:space-y-12">
                {careerMilestones.map((milestone: any, index: number) => (
                  <motion.div
                    key={milestone.id}
                      ...
                      >
                        ...
                        <div className="mb-4">
                          ...
                          <ul className="space-y-2">
                            {milestone.highlights.slice(0, 3).map((highlight: string, idx: number) => (
                        ...
                        <div className="flex flex-wrap gap-2">
                          {milestone.skills.slice(0, 3).map((skill: string, idx: number) => (
