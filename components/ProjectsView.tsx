...
const videoHighlights: VideoHighlight[] = [
  ...
  },
  {
    ...
    kind: 'mp4',
    project: 'school',
    series: 'Amville School Highlights',
  },
  {
  ...
  {
    id: 'owowo-farm-settlement-agricultural-intervention',
    title: 'Owowo Farm Settlement Agricultural Intervention',
...
export default function Projects({ projects: projectsProp }: { projects?: any[] } = {}) {
  const projects: any[] = projectsProp && projectsProp.length ? projectsProp : defaultProjects
  ...
  const currentMilestone = selectedMilestone 
    ? currentProject.milestones.find((m: any) => m.id === selectedMilestone)
    : null
  ...
  return (
    <div className="min-h-screen">
                  ...
                  <div className="p-4 lg:p-6 bg-white">
                    ...
                    <div className="mb-8">
                      ...
                      <div className="space-y-4">
                        {currentProject.milestones.map((milestone: any, index: number) => (
                          <motion.div
                            key={milestone.id}
                                        ...
                                        <div className="relative">
                                          ...
                                          {currentMilestone.images.length > 1 && (
                                            <div className="flex justify-center mt-3 space-x-2">
                                              {currentMilestone.images.map((_: any, imgIndex: number) => (
                                                <button
                                                  key={imgIndex}
                                    ...
                                    <div className="grid lg:grid-cols-2 gap-4 mb-4">
                                      <div className="bg-white p-3 rounded-lg border border-slate-200">
                                        ...
                                        <div className="space-y-2">
                                          {currentMilestone.achievements.map((achievement: any, achieveIndex: number) => (
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                          {Object.entries(currentMilestone.metrics).map(([key, value]) => (
                                            <div key={key} className="bg-gradient-to-br from-primary-50 to-gold-50 p-3 rounded-lg border border-primary-200">
                                              <div className="text-lg font-bold text-primary-800">{value as any}</div>
                ...
                <div className="flex flex-col lg:flex-row gap-0 h-full">
                  ...
                  <div className="lg:w-1/2 relative bg-slate-800 overflow-hidden flex-shrink-0">
                    ...
                    <div className="hidden lg:grid lg:grid-cols-3 gap-2 p-4 h-full">
                      {currentProject.milestones[currentSlideIndex].images.map((image: any, idx: number) => (
                        ...
                        >
                          ...
                          {currentProject.milestones[currentSlideIndex].images.length > 1 && (
                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
                              {currentProject.milestones[currentSlideIndex].images.map((_: any, dotIdx: number) => (
                                <div
                                  key={dotIdx}
                  ...
                  <div className="lg:w-1/2 p-6 lg:p-8 flex flex-col justify-center overflow-y-auto max-h-[calc(90vh-12rem)] lg:overflow-visible lg:max-h-none">
                    ...
                    >
                      {currentProject.milestones.map((_: any, index: number) => (
                        <div
                          key={index}
                    ...
                    >
                      {Object.entries(currentProject.milestones[currentSlideIndex].metrics).slice(0, 2).map(([key, value]) => (
                        ...
                        >
                          <div className="text-xl font-bold text-primary-400 mb-1">{value as any}</div>
      ...
      <ScrollControls sections={["projects-hero", "projects-timeline", "projects-cta"]} />
    </div>
  )
}
