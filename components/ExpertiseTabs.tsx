    ...
    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900 mb-4 relative inline-block">
      Core Areas of <span className="text-slate-900">Expertise</span>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className={`relative rounded-2xl sm:rounded-2xl shadow-large overflow-hidden mb-8 mx-0 sm:mx-4 lg:mx-8 ${
        ...
        >
            <AnimatePresence mode="wait">
              {activeArea && (
				...
				? <>Led an over <span className="font-bold text-lg text-primary-600 inline-block mx-0.5">$250M</span> World Bank initiative achieving 40% efficiency gains and impacting <a href="https://punchng.com/ogun-empowers-over-72000-residents-with-agric-skills/" target="_blank" rel="noopener noreferrer" className="font-semibold text-primary-600 hover:text-primary-700 underline" title="Verified source">72,000+ beneficiaries</a> in Ogun State.</>
